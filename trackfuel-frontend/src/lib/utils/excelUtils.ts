...
const templateData = {
  ...
  User: [
    ['id', 'email', 'matricule', 'nom', 'prenom', 'role', 'fonction', 'site_id', 'password_hash'],
    [1, 'admin@trackfuel.mg', 'ADM001', 'Admin', 'Principal', 'admin', 'directeur', 1, 'password_hash'],
    [2, 'jean.rakoto@trackfuel.mg', 'DRV001', 'Rakoto', 'Jean', 'conducteur', 'conducteur', 1, 'password_hash'],
    [3, 'maria.rabe@trackfuel.mg', 'DRV002', 'Rabe', 'Maria', 'conducteur', 'conducteur', 2, 'password_hash'],
    [4, 'auditeur@trackfuel.mg', 'AUD001', 'Controle', 'Interne', 'auditor', 'assistant', 1, 'password_hash'],
  ],
  DriverProfile: [
